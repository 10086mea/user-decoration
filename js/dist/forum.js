...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_DecorationBox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/DecorationBox */ "./src/forum/components/DecorationBox.tsx");



function storeBox(app) {
  flarum.extensions['xypp-store'].addFrontendProviders("decoration", app.translator.trans("xypp-store.forum.create-modal.providers.decoration"), /*#__PURE__*/function () {
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            app.store.all('user-decorations').forEach(function (decoration) {
              providerDatas[parseInt(decoration.id())] = '[' + app.translator.trans('xypp-user-decoration.forum.decoration-box.' + decoration.attribute('type')) + ']' + decoration.attribute('name') + ':' + decoration.attribute('desc');
            });
          case 3:
          case "end":
            return _context.stop();
    ...
    var info = item.itemData();
    return m("div", {
      "class": "decoration-ShowCase"
    }, m(_components_DecorationBox__WEBPACK_IMPORTED_MODULE_2__["default"], {
